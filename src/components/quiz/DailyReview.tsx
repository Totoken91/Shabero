...
function makeQuestions(phrases: Phrase[]) {
  const all = scenarios.flatMap((s) => s.phrases)
...
export default function DailyReview() {
  ...
  const [questions] = useState(() => makeQuestions(pickReviewPhrases(count)))
    ...
    return (
      <div className="max-w-[400px] mx-auto">
        <div className="phrase-card p-6 text-center">
          ...
          <p className="relative z-10 text-[14px] font-bold text-emerald-600 mt-1">Révision terminée !</p>
          <p className="relative z-10 text-[12px] text-[var(--text-light)] mt-2">Reviens demain pour garder ton streak</p>
        </div>
  ...
  return (
    <div className="pb-8">
      ...
      <div className="detail-header p-4 text-white text-center mb-4">
        <h1 className="relative z-10 text-[18px] font-[800] m-0">Révision du jour</h1>
